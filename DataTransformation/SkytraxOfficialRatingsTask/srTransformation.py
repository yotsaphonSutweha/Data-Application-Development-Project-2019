...
officialRatingsAnalysis = {
    'Skytrax official rating' : ['Seat comfort rating', 'Cabin service rating', 'Food and beverages rating', 'Inflight entertainment rating', 'Ground service rating', 'Wifi connectivity rating'],
...
dataframe = pd.DataFrame(officialRatingsAnalysis, columns=['Skytrax official rating', 'Mean value'])

dataframe.to_csv(r'./Output/official_rating_analysis.csv', index=None, header=True)